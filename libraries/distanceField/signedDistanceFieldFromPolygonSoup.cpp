...
ObjMesh * SignedDistanceFieldFromPolygonSoup::ComputeIsosurface(DistanceFieldBase * distanceField, double sigma)
{
  ...
  marchingCubesResult->save("D:/GraduationProject/Vega/models/newgrass/128sigm05/marchingCubesResult.obj");
  ...
  outputMesh->save("D:/GraduationProject/Vega/models/newgrass/128sigm05/RemovinginteriorMesh.obj");
    ...
    int closestPointFlag, const char* precomputedUnsignedFieldFilename)
{
  ...
  isoMesh->save("D:/GraduationProject/Vega/models/newgrass/128sigm05/DistanceIsoMesh.obj");
