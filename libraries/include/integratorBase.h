...
protected:
  ...
  double * q; // current deformation amplitudes 当前形变振幅
  ...
  double * qresidual, * qdelta; // aux integration variables 辅助积分变量
  double * q_1; // deformation amplitudes at previous time-step 上一帧的形变
  double * qvel_1;
  double * qaccel_1;
