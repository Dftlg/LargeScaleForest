...
int main(int argc, char **argv)
{
 /* int numFixedArg = 4;
  ...
  initPredicates();
  char * fieldFilename = "D:\\GraduationProject\\Vega\\models\\turtle\\128sigm05\\05turtle128.dist";
  char * surfaceMeshFilename = "D:\\GraduationProject\\Vega\\models\\turtle\\128sigm05\\05turtle128.dist";
 /* printf("fieldFilename %s.\n", fieldFilename);
  printf("surfaceMeshFilename %s.\n", surfaceMeshFilename);*/
  double triangleSize = atof("0.1");
  char * objMeshFilename = "D:\\GraduationProject\\Vega\\models\\turtle\\128sigm05\\tr0505isobeam128.obj";
 /* printf("objMeshFilename %s.\n", objMeshFilename);*/
 /* char * fieldFilename = argv[1];
  ...
  else
  {
    ...
    mesher.checkDelaunayAfterComputation(checkDelaunay);
	mesher.saveMarchingCubesMesh(true);
