...
int main( int argc, char** argv )
{
  ...
  int resolutionX = strtol("128", NULL, 10);
  int resolutionY = strtol("128", NULL, 10);
  int resolutionZ = strtol("128", NULL, 10);
  ...
  char * objMeshname = "D:/GraduationProject/Vega/models/newgrass/1.obj";
  printf("objMeshname %s.\n", objMeshname);
  bool doublePrecision = false;
  bool narrowBandField = false;
  bool signedField = false;
  char outputFile[4096] = "D:/GraduationProject/Vega/models/newgrass/05grass128.dist";
  int mode = 1;

  bool useCubeBox = false;
  char bboxString[4096] = "__default";
  double expansionRatio = 3 ;
