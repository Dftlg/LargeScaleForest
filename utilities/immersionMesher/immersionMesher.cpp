...
static string finalTetMeshFilename = "D:/GraduationProject/Vega/models/turtle/exenew/turtlenew.veg";
static string finalBarycentricWeightsFilename = "D:/GraduationProject/Vega/models/turtle/exenew/finalTet.interp";
...
int main (int argc, char ** argv)
{
  ...
  surfaceMeshFilename = "D:/GraduationProject/Vega/models/turtle/turtle.obj";
  printf("surfaceMeshFilename %s.\n", surfaceMeshFilename);
  tetMeshFilename = "D:/GraduationProject/Vega/models/turtle/turtle-volumetric-heterogeneous.veg";
  printf("tetMeshFilename %s.\n", tetMeshFilename);
